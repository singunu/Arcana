...
public class A_FieldCardBorderSep : MonoBehaviour
{
    private Image borderImage; // 테두리에 적용된 Image 컴포넌트를 할당하세요
    public float degree;
    public float blinkSpeed = 1f; // 깜빡이는 속도
    // public Color baseColor = new Color(0f, 1f, 0.937f); // 00FFEF 색상
