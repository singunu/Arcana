...
const races = [
  ...
  { 
    ...
    image: '/assets/races/1. 실키 (Silky - 속삭이는 미스티).jpg',
  },
  {
    name: '브라우니 (Brownie)',
    description: '가정의 일을 돕는 작은 요정입니다. 밤에 몰래 나타나 집안일을 돕지만 모습을 드러내지 않습니다.',
    image: '/assets/races/2. 브라우니 (Brownie - 소란스러운 니비).jpg',
  },
  {
    name: '그렘린 (Gremlin)',
    description: '기계와 기술에 장난을 치며, 망가뜨리는 능력이 있어 골칫거리가 될 수 있습니다.',
    image: '/assets/races/3. 그렘린 (Gremlin - 소동 그렘린 릭킥).jpg',
  },
  ...
  // 두번째 그룹 (체력 15)
  {
    ...
    image: '/assets/races/4. 임프 (Imp - 화염 임프 자크).jpg',
  },
  {
    name: '코볼트 (Kobold)',
    description: '지하에서 생활하며 마법과 함정을 능숙하게 다룹니다.',
    image: '/assets/races/5. 코볼트 (Kobold - 광부 드릭).jpg',
  },
  {
    name: '고블린 (Goblin)',
    description: '민첩하고 교활하며, 단체로 행동하며 장난과 약탈을 즐깁니다.',
    image: '/assets/races/6. 고블린 (Goblin - 약탈자 그럭).jpg',
  },
  ...
  // 세번째 그룹 (체력 20)
  {
    ...
    image: '/assets/races/7. 드워프 (Dwarf - 수호자 오린).jpg',
  },
  {
    name: '유니콘 (Unicorn)',
    description: '순수함과 치유의 상징이며, 마법적 치유 능력을 지니고 있습니다.',
    image: '/assets/races/8. 유니콘 (Unicorn - 환영의 오리나).jpg',
  },
  {
    name: '켄타우로스 (Centaur)',
    description: '인간과 말의 모습을 결합한 존재로, 힘과 지혜를 겸비한 전사입니다.',
    image: '/assets/races/9. 켄타우로스 (Centaur - 중재자 에리온).jpg',
  },
  ...
  // 네번째 그룹 (체력 25)
  {
    ...
    image: '/assets/races/10. 엘프 (Elf - 단장 실바).jpg',
  },
  {
    name: '오크 (Orc)',
    description: '강한 체력을 지닌 전사 종족으로 조직적인 군대를 이룹니다.',
    image: '/assets/races/11. 오크 (Orc - 족장 두록).jpg',
  },
  {
    name: '트롤 (Troll)',
    description: '강한 재생 능력을 가진 거대한 생물로 햇빛 아래에서 돌로 변하는 약점이 있습니다.',
    image: '/assets/races/12. 트롤 (Troll - 트롤 트라그).jpg',
  },
  {
    name: '자이언트 (Giant)',
    description: '거대한 체구와 막강한 힘을 지닌 종족으로 산을 움직일 수 있습니다.',
    image: '/assets/races/13. 자이언트 (Giant - 전사 브론).jpg',
  },
  ...
  // 마지막 (드래곤)
  {
    ...
    image: '/assets/races/14. 드래곤 (Dragon - 드래곤군주 발카르).jpg',
  },
];
              ...
              <SwiperSlide key={race.name}>
                <div className="swiper-slide-inner relative p-4 bg-zinc-800/90 rounded-lg
                  ...
                  <div className="content flex flex-col flex-grow">
                    <h3 className="font-pixel text-xl md:text-2xl text-center mb-6
