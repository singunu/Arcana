      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative mb-12 sm:mb-16 md:mb-20">
          <div className="relative mx-auto w-fit">
            <div className="relative px-8 py-4 bg-zinc-900/80 backdrop-blur-sm 
        ...
        <div className="space-y-12 md:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative group">
              <div className="relative p-8 bg-zinc-900/80 backdrop-blur-sm rounded-xl 
                            border border-zinc-800/50 overflow-hidden">
                {/* Ambient glow background */}
                <div className="absolute -inset-[1px] bg-gradient-to-b from-blue-500/15 via-transparent to-teal-500/15 
                              rounded-xl blur-sm" />
                ...
                <div className="absolute -right-px top-0 h-full w-px 
                              bg-gradient-to-b from-transparent via-teal-500/50 to-transparent" />

                {/* Content */}
                <div className="relative z-10">
                  <h3 className="text-2xl md:text-3xl font-pixel mb-8 text-transparent bg-clip-text 
                              bg-gradient-to-r from-blue-400 to-teal-400">
                    아르카나의 세계
                  </h3>

                  <p className="text-lg md:text-xl lg:text-2xl font-content text-gray-300/90 
                              leading-8 md:leading-9 lg:leading-10 tracking-wide 
                              max-w-prose break-keep
                              [word-spacing:2px] md:[word-spacing:3px]
                              [text-wrap:pretty]
                              after:content-['|'] 
                              after:ml-[2px]
                              after:animate-[cursor_0.8s_step-end_infinite]
                              after:text-blue-400">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 to-teal-500/20 
                            rounded-xl blur-xl opacity-0 group-hover:opacity-70 
                            transition-all duration-700 -z-10" />
            </div>

            {/* 오른쪽: 이미지 */}
            <div className="relative group">
              <div className="relative bg-zinc-900/80 backdrop-blur-sm rounded-xl 
                            border border-zinc-800/50 overflow-hidden p-3">
                {/* Ambient glow background */}
                <div className="absolute -inset-[1px] bg-gradient-to-b from-blue-500/15 via-transparent to-teal-500/15 
                              rounded-xl blur-sm" />
